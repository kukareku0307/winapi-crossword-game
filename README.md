...
В ходе выполнения курсовой работы была разработана программа для составления Кроссворда. В результате были приобретены навыки по работе с функциями WinAPI из библиотеки &lt;Windows.h&gt;, был разработан понятный графический интерфейс и алгоритм, для реализации составителя кроссворда по введенным пользователем словам.
